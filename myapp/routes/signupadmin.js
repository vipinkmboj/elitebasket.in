...
router.post('/', function(req, res, next) {
    ...
    if(password != confirmPassword || password == '' || confirmPassword == '') {
      res.render('signupadmin', { title: 'Elite Basket', msg:'Password Not Matched, Please Try again', adminDetails: ''});
    } else {
      ...
      getAdminDetails.exec((err, ExistingAdminDetails)=> {
        ...
        if(ExistingAdminDetails == null || ExistingAdminDetails == '') {
          res.render('signupadmin', { title: 'Elite Basket', msg:'Wrong OTP Entered, Please Try again', adminDetails:''});
