...
var employeesStaffModel = require('../models/employeesstaffteamschema');
...
router.get('/', function(req, res, next) {
  res.render('signupformemployees', { title: 'Elite Basket', msg: '' });
});
...
//
  usernamesListModel.findOne({Username: username}, {Username: username}).exec((err, dataUsernameInUsernameList) => {
    ...
    if(dataUsernameInUsernameList != null) {
      return res.render('signupformemployees', {title: 'Elite Basket', msg:'Username Not Available, Please Try Another One' });
    } else {
    //}
  //});
  //
  adminModel.findOne({Username: username}, {Username: username}).exec((err, dataUsernameInAdmin) => {
      ...
      if(dataUsernameInAdmin != null) {
          ...
          return res.render('signupformemployees', {title: 'Elite Basket', msg:'Username Already Exists in Admin Data' });
        ...
        employeesModel.findOne({Username: username}).exec((err, dataUsernameInEmployees)=> {
          ...
          if(dataUsernameInEmployees != null) {
            return res.render('signupformemployees', {title: 'Elite Basket', msg:'Username Already Exists in Employees Data' });
          } else {
        ...
        customerModel.findOne({Username: username}).exec((err, dataUsernameInCustomers) => {
          ...
          if(dataUsernameInCustomers != null) {
            return res.render('signupformemployees', {title: 'Elite Basket', msg:'Username Already Exists in Customer Data' });
           ...
           adminModel.findOne({Mobilenumber: mobilenumber}, {Mobilenumber: mobilenumber}).exec((err, dataMobileNumberInAdmin) => {
            ...
            if(dataMobileNumberInAdmin != null) {
              return res.render('signupformemployees', {title: 'Elite Basket', msg:'Mobile Number Already Registered in Admin Data' });
        ...
        employeesModel.findOne({Mobilenumber: mobilenumber}, {Mobilenumber: mobilenumber}).exec((err, dataMobileNumberInEmployees)=> {
          ...
          if(dataMobileNumberInEmployees != null) {
            return res.render('signupformemployees', {title: 'Elite Basket', msg:'Mobile Number Already Exists in Employees Data' });
          } else {
        ...
        //
              ...
              customerModel.findOne({Mobilenumber: mobilenumber}, {Mobilenumber: mobilenumber}).exec((err, dataMobileNumberInCustomer) => {
                ...
                if(dataMobileNumberInCustomer != null) {
                  return res.render('signupformemployees', {title: 'Elite Basket', msg:'Mobile Number Already Registered in Customer Data' });

                } else {
                  adminModel.findOne({Email: email}, {Email: email}).exec((err, dataEmailInAdminData) => {
                    if(err) throw err;
                    if(dataEmailInAdminData != null) {
                      return res.render('signupformemployees', {title: 'Elite Basket', msg:'Email Id Already Registered in Admin Data' });
        ...
        employeesModel.findOne({Email: email}, {Email: email}).exec((err, dataEmailInEmployees)=> {
          ...
          if(dataEmailInEmployees != null) {
            return res.render('signupformemployees', {title: 'Elite Basket', msg:'Email Id Already Exists in Employees Data' });
          } else {
        ...
        //
                      ...
                      customerModel.findOne({Email: email}, {Email: email}).exec((err, dataEmailInCustomerData) => {
                        ...
                        if(dataEmailInCustomerData != null) {
                          ...
                          return res.render('signupformemployees', {title: 'Elite Basket', msg:'Email Already Registered in Customer Data' });
                          ...
                          adminModel.findOne({Nationalid :nationalid}, {Nationalid :nationalid}).exec((err, dataNationalIdInAdminData) => {
                           ...
                           if(dataNationalIdInAdminData != null) {
                            return res.render('signupformemployees', {title: 'Elite Basket', msg:'National Id Already Registered in Admin Data' });
        ...
        employeesModel.findOne({Nationalid :nationalid}, {Nationalid :nationalid}).exec((err, dataNationalIdInEmployees)=> {
          ...
          if(dataNationalIdInEmployees != null) {
            return res.render('signupformemployees', {title: 'Elite Basket', msg:'National Id Already Exists in Employees Data' });
          } else {

          //}
        //});
        //
        employeesStaffModel.findOne({Email: email}, {Email: email}).exec((err, registeredNewAdminMemberEmail) => {
                                if(err) throw err;
                                if(registeredNewAdminMemberEmail == null || registeredNewAdminMemberEmail.Email != 'vipinkmboj22@gmail.com') {
                                  return res.render('signupformemployees', {title: 'Elite Basket', msg:'Please Enter Registered Email Address or Contact Admin' });

                                } else {                              
                             //
                             //
                            //return res.render('admin', {title: 'SaReGaMa Music Academy & GMP Studio', msg:'National Id Already not Registered in Admin Data' });
                            var adminDetails = new employeesModel({
                              Firstname: firstname,
                              Lastname: lastname,
                              Username: username,
...
ses.sendEmail(params, (err) => {
  if(err) {
    res.render('signupformemployees', { title: 'Elite Basket', msg:'Error Occured, Email Sending failed', adminDetails: ''}); 
  } else {
    res.render('signupemployees', { title: 'Elite Basket', msg:'Please check the One Time Password (OTP) sent to your Email and enter it here', adminDetails: ''}); 
  }
});
                          //
