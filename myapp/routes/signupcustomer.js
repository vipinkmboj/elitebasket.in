...
router.post('/', function(req, res, next) {
    ...
    if(password != confirmPassword || password == '' || confirmPassword == '') {
      ...
      var getAdminDetails = customerModel.findOne({Onetimepassword: oneTimePassword}, {});
      getAdminDetails.exec((err, ExistingAdminDetails)=> {
        ...
        if(ExistingAdminDetails == null || ExistingAdminDetails == '') {
          ...
          customerModel.findByIdAndUpdate(getAdminId, {Onetimepassword: null, Password: password}, {upsert: true}, function(err, updatedAdminDetails){
            if(err) throw err; 
            //
